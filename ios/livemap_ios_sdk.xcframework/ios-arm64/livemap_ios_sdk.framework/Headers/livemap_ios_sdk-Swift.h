...
SWIFT_CLASS("_TtC15livemap_ios_sdk8Attitude")
@interface Attitude : JSON
...
SWIFT_CLASS("_TtC15livemap_ios_sdk6Marker")
@interface Marker : JSON
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC15livemap_ios_sdk14OfflineOptions")
@interface OfflineOptions : JSON
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC15livemap_ios_sdk19PolestarCoordinates")
@interface PolestarCoordinates : JSON
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (void)onIndoorFeatureClick:(wemapsdk * _Nonnull)wemapController data:(NSDictionary<NSString *, id> * _Nonnull)data;
- (void)onIndoorLevelChanged:(wemapsdk * _Nonnull)wemapController data:(NSDictionary<NSString *, id> * _Nonnull)data;
- (void)onIndoorLevelsChanged:(wemapsdk * _Nonnull)wemapController data:(NSArray * _Nonnull)data;
- (void)onPermissionsDenied:(wemapsdk * _Nonnull)wemapController deniedPermissions:(NSArray<NSString *> * _Nonnull)deniedPermissions;
- (void)onInaccurateMagnetometer:(wemapsdk * _Nonnull)wemapController;
